...
Репозиторий является зафиксированной для сдачи домашнего задания версией кода бота для предсказания индекса популярности
...
содержит код данного бота в подкаталоге ```tg-bot```. 
